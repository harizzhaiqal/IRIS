...
export default async function StaffTrainingDirectoryPage({
  searchParams,
}: {
    ...
    <div className="space-y-6">
      <div className="space-y-1">
        ...
        <p className="text-sm text-muted-foreground">
          Search staff training totals and download yearly reports.
        </p>
      </div>
      ...
      <StaffTrainingDirectory
        ...
        year={year}
        years={years}
        bulkExportHref={`/training/export/all?year=${year}`}
      />
    </div>
  );
}
